...
const Alert = ({ message, handleClick }: AlertProps) => {
  return (
    <motion.div
      className='m-auto flex h-[65px] w-[90%] max-w-[800px] items-center gap-2 rounded-2xl bg-purple-100 py-3 pr-3 pl-5'
    ...
    >
      ...
      {handleClick && (
        <Button className='h-[41px] max-w-[138px] px-5 py-3' variant='primary' onClick={handleClick}>
