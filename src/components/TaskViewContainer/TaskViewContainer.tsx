...
export default function TaskViewContainer({
  ...
  return (
    <div ref={setNodeRef} className='flex h-[400px] w-full flex-col gap-2 sm:h-full'>
      ...
      {items.length > 0 ? (
        <div
          className={cn(
            ...
            isListView ? 'flex flex-col space-y-2' : 'grid-auto-rows-auto grid grid-cols-3 gap-2',
