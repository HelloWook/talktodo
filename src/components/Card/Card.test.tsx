...
describe('Card', () => {
  ...
  describe('Card.Provider와 Card 기본 렌더링', () => {
    it('Card가 올바르게 렌더링된다', () => {
      render(
        <Card.Provider task={mockTask} onToggleDone={mockHandlers.onToggleDone} onOpenMemo={mockHandlers.onOpenMemo} layout='card'>
          <Card>
            <Card.Title />
            <Card.Description />
            <Card.Data />
    ...
    describe('Card.Title', () => {
      ...
      it('완료된 작업의 제목이 올바르게 렌더링된다', () => {
        render(
          <Card.Provider task={mockTaskDone} onToggleDone={mockHandlers.onToggleDone} onOpenMemo={mockHandlers.onOpenMemo} layout='card'>
            <Card>
              <Card.Title />
            </Card>
          </Card.Provider>,
